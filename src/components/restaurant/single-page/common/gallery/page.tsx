          ...
          <div className="col-lg-4 col-sm-6">
            <div className="overlay">
              <a href="/assets/images/restaurant/environment/1.jpg">
                ...
                <img
                  src="/assets/images/restaurant/environment/1.jpg"
                  alt=""
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="overlay">
              <a href="/assets/images/restaurant/environment/2.jpg">
                ...
                <img
                  src="/assets/images/restaurant/environment/2.jpg"
                  alt=""
                  className="img-fluid bg-img"
                />
              </a>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="overlay">
              <a href="/assets/images/restaurant/environment/4.jpg">
                ...
                <img
                  src="/assets/images/restaurant/environment/4.jpg"
                  alt=""
                  className="img-fluid bg-img"
                />
              </a>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="overlay">
              <a href="/assets/images/restaurant/environment/5.jpg">
                ...
                <img
                  src="/assets/images/restaurant/environment/5.jpg"
                  alt=""
                  className="img-fluid bg-img"
                />
              </a>
          ...
          <div className="col-lg-4 col-sm-6">
            <div className="overlay">
              <a href="/assets/images/restaurant/environment/6.jpg">
                ...
                <img
                  src="/assets/images/restaurant/environment/6.jpg"
                  alt=""
                  className="img-fluid bg-img"
                />
              </a>
