  ...
  return (
    <div className="desc-box" id="policy">
      ...
      <div className="menu-part policy page-section">
        ...
        <p>
          Should any action by a guest be deemed inappropriate by the hotel, or
          if any inappropriate behavior is brought to the attention of the
        ...
        <p>
          ...
          fast refunds. Our standard check-in time is 12 noon and you can
          check-in any time after that till your reservation is valid.
        </p>
