...
const FacilityFilter: React.FC = () => {
  ...
  const facilityStatus = useSelector(
    (state: RootState) => state.hotelFilterReducer.facilityStatus,
  );
              ...
              return (
                ...
                >
                  <input
                    ...
                    id={data.type}
                    value={data.type}
                    checked={facilityStatus.includes(data.type)}
