...
const HostLanguageFilter: React.FC = () => {
  ...
  const hostLangStatus = useSelector(
    (state: any) => state.hotelFilterReducer.hostLangStatus,
  );
              ...
              return (
                ...
                >
                  <input
                    ...
                    id={data.type}
                    value={data.type}
                    checked={hostLangStatus.includes(data.type)}
